 ...
 * that will be called by {@link Session} each turn in order to ask the participant's snake
 * which direction it wishes to move in.
 *
...
{
	/**
	 * Returns which direction this brain wishes its snake to move in. Given a {@link GameState}
